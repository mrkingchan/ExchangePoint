...
-(void)maProfileWithModel:(Y_KLineModel *)model
{
    ...
    _openLabel.text = [NSString stringWithFormat:@"%.3f",model.Open.floatValue];
    _highLabel.text = [NSString stringWithFormat:@"%.3f",model.High.floatValue];
    _lowLabel.text = [NSString stringWithFormat:@"%.3f",model.Low.floatValue];
    _closeLabel.text = [NSString stringWithFormat:@"%.3f",model.Close.floatValue];
