...
#pragma mark - 私有方法
#pragma mark 创建工具条  此处有修改 _toolbar.frame = CGRectMake(0, barY, self.view.frame.size.width, barHeight);
- (void)createToolbar
{
    CGFloat barHeight = 44;
    CGFloat barY = self.view.frame.size.height - barHeight;
    _toolbar = [[MJPhotoToolbar alloc] init];
    _toolbar.frame = CGRectMake(self.view.frame.size.width * 0.5, barY, self.view.frame.size.width, barHeight);
